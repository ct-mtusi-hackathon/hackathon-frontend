...
const SideMenu = (props)=> {
    ...
    const exitProfile = ()=>{
        props.setCurrentPage(<Login setCurrentPage={props.setCurrentPage} theme={props.theme} setTheme={props.setTheme}/>);
    }
  return (
    <div className='SideMenu'>
        ...
        <div className='SMElement SMElementHeader'>
            Меню навигации
        </div>
        {buttons.map(BtnTitle=>
            <div className='SMElement'>
                {BtnTitle}
            </div>
            )}
    </div>
